...
export const EXERCISES: Exercise[] = [
...

  {
    ...
    name: 'Benkpress',
    muscleGroup: 'chest',
    primaryMuscles: ['pec_major_upper', 'pec_major_lower', 'delt_anterior', 'triceps_long', 'triceps_lateral', 'triceps_medial'],
    secondaryMusclesDetailed: ['serratus_anterior', 'trap_lower', 'pec_minor'],
...

  {
    ...
    muscleGroup: 'chest',
    primaryMuscles: ['pec_major_upper', 'delt_anterior', 'triceps_long', 'triceps_lateral'],
    secondaryMusclesDetailed: ['serratus_anterior', 'trap_lower'],
    movementPattern: 'horizontal_push',
...

  {
    ...
    muscleGroup: 'chest',
    primaryMuscles: ['pec_major_lower', 'triceps_long', 'triceps_lateral', 'triceps_medial'],
...

  {
    ...
    muscleGroup: 'chest',
    primaryMuscles: ['pec_major_upper', 'pec_major_lower', 'delt_anterior', 'triceps_long', 'triceps_lateral'],
    secondaryMusclesDetailed: ['serratus_anterior', 'trap_lower'],
    movementPattern: 'horizontal_push',
    tier: 'compound_secondary',
...

  {
    ...
    muscleGroup: 'chest',
    primaryMuscles: ['pec_major_upper', 'pec_major_lower', 'delt_anterior', 'triceps_long', 'triceps_lateral'],
    secondaryMusclesDetailed: ['serratus_anterior', 'rectus_abdominis', 'glute_max'],
    movementPattern: 'horizontal_push',
    tier: 'compound_secondary',
...

  {
    ...
    muscleGroup: 'chest',
    primaryMuscles: ['pec_major_upper', 'pec_major_lower', 'delt_anterior', 'triceps_lateral', 'triceps_medial'],
    secondaryMusclesDetailed: ['serratus_anterior'],
    movementPattern: 'horizontal_push',
    tier: 'compound_secondary',
    equipmentTypes: ['bodyweight'],
    equipment: 'Kroppsvekt',
...

  {
    ...
    muscleGroup: 'chest',
    primaryMuscles: ['pec_major_lower', 'delt_anterior', 'triceps_long', 'triceps_lateral', 'triceps_medial'],
    secondaryMusclesDetailed: ['pec_minor', 'rhomboids'],
    movementPattern: 'horizontal_push',
    tier: 'compound_secondary',
    equipmentTypes: ['bodyweight'],
...

  {
    ...
    name: 'Bryst-fly',
    muscleGroup: 'chest',
    primaryMuscles: ['pec_major_upper', 'pec_major_lower', 'delt_anterior'],
    secondaryMusclesDetailed: ['serratus_anterior', 'biceps_brachii'],
    movementPattern: 'horizontal_push',
    tier: 'isolation',
    equipmentTypes: ['dumbbell'],
    equipment: 'Manualer',
...

  {
    ...
    primaryMuscles: ['delt_anterior', 'delt_lateral', 'triceps_long', 'triceps_lateral', 'triceps_medial'],
    secondaryMusclesDetailed: ['trap_upper', 'serratus_anterior', 'rectus_abdominis'],
...

  {
    ...
    secondaryMusclesDetailed: ['trap_upper', 'serratus_anterior'],
    movementPattern: 'vertical_push',
    tier: 'compound_secondary',
    equipmentTypes: ['dumbbell'],
    equipment: 'Manualer',
...

  {
    ...
    name: 'Arnold Press',
    muscleGroup: 'shoulders',
    primaryMuscles: ['delt_anterior', 'delt_lateral', 'delt_posterior', 'triceps_long', 'triceps_lateral'],
    secondaryMusclesDetailed: ['trap_upper', 'serratus_anterior'],
    movementPattern: 'vertical_push',
    tier: 'compound_secondary',
    equipmentTypes: ['dumbbell'],
